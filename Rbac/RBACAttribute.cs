...
public class RBACAttribute : AuthorizeAttribute
{
    public override void OnAuthorization(AuthorizationContext filterContext)
    {
        ...
        if ((bool)(!requestingUser.HasPermission(requiredPermission) & !requestingUser.IsSysAdmin))
        {
            ...
            filterContext.Result = new RedirectToRouteResult(new RouteValueDictionary { { "action", "Unauthorised" }, { "controller", "Account" } });
        }
